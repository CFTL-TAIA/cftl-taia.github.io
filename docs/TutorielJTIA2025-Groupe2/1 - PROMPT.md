...
Troisième étape, le prompt doit générer le code source de test en Karaté. Le code source doit contenir un fichier pom.xml incluant toutes les dépendantes nécessaires. 
